                        ...
                        <div class="sm:col-span-6">
                            ...
                            <div class="mt-1">
                                <input type="text" id="first_name" wire:model.lazy="first_name" name="first_name"
                                    class="block w-full transition @error('first_name') border-red-400 @enderror"
                        ...
                        <div class="sm:col-span-6">
                            ...
                            <div class="mt-1">
                                <input type="text" id="last_name" wire:model.lazy="last_name" name="last_name"
                                    class="block w-full transition @error('last_name') border-red-400 @enderror"
                                    value="{{ old('last_name') }}" />
                            </div>
                            @error('last_name')
                                <div class="text-sm text-red-400">{{ $message }}</div>
                        ...
                        <div class="sm:col-span-6">
                            ...
                            <div class="mt-1">
                                <input type="email" id="email" wire:model.lazy="email" name="email"
                                    class="block w-full transition @error('email') border-red-400 @enderror"
                                    value="{{ old('email') }}" />
                            </div>
                            @error('email')
                                <div class="text-sm text-red-400">{{ $message }}</div>
                        ...
                        <div class="sm:col-span-6">
                            ...
                            <div class="mt-1">
                                <input type="text" id="tel_number" wire:model.lazy="tel_number" name="tel_number"
                                    class="block w-full transition @error('tel_number') border-red-400 @enderror"
                        ...
                        <div class="sm:col-span-6">
                            ...
                            <div class="mt-1">
                                <input type="datetime-local" id="res_date" wire:model.lazy="res_date" name="res_date"
                                    class="block w-full transition @error('res_date') border-red-400 @enderror"
                                    value="{{ old('res_date') }}" />
                            </div>
                            @error('res_date')
                                <div class="text-sm text-red-400">{{ $message }}</div>
                        ...
                        <div class="sm:col-span-6">
                            ...
                            <div class="mt-1">
                                <input type="number" id="guest_number" wire:model.lazy="guest_number"
                                    name="guest_number"
                                    class="block w-full transition @error('guest_number') border-red-400 @enderror"
